...
def download_youtube_files(logger,files):
    ...
    for sound in files:
        with youtube_dl.YoutubeDL(ydl_opts) as ydl:
            ...
            info = ydl.extract_info(sound, download=False)  # extract_info es una funcion de ydk que va a return un dictionari con informacin de ese url
            ...
            if take_year == '2020':
                ...
                file_path = ydl.prepare_filename(info)  # prepare_filename es otra funcion de ydl va a retun el fiel name del url que le pasemo 10 seconds shor music
